                ...
                <div className={`text-center relative z-10 rounded-2xl ${!isDarkMode && 'bg-white/10 backdrop-blur-sm shadow-xl p-8'}`}>
                    ...
                    >
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className={`backdrop-blur-sm px-6 md:px-8 py-3 rounded-lg font-medium shadow-lg transition-all flex items-center justify-center space-x-2 border ${isDarkMode
